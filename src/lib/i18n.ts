    ...
    services: {
      ...
      items: {
        ...
        customSoftware: {
          ...
          description: "Soluciones personalizadas diseñadas desde cero para resolver los desafíos específicos de tu negocio.",
        },
        apiIntegrations: {
        ...
        uxUiDesign: {
          ...
          description: "Diseño centrado en el usuario combinado con desarrollo pixel-perfect para experiencias que convierten.",
        },
      },
    },
    work: {
